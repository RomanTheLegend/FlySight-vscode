...
#define SCAN_P (0x320)
#define SCAN_L (0x320)
#define CONN_P1		(CONN_P(15))
#define CONN_P2		(CONN_P(30))
...
typedef enum
{
  ...
  /* USER CODE BEGIN CFG_Task_Id_With_NO_HCI_Cmd_t */
    ...
    CFG_TASK_FS_ACTIVELOOK_CONTROL_PRODUCER_ID,
    CFG_TASK_FS_ACTIVELOOK_CONTROL_CONSUMER_ID,
    ...
    CFG_TASK_ACTIVELOOK_DISPLAY_UPDATE_ID,
